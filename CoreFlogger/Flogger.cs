...
namespace CoreFlogger
{
    public static class Flogger
    {
        ...
        static Flogger()
        {
            var connStr = LogConfig.Current.ConnectionString ??
                         "Data Source=PSL-DBSERVER-VM3\\SQL2012;User ID=sa;Password=SymBoL$1948;Initial Catalog=ErrorLog;Trusted_Connection=True";
